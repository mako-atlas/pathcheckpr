...
import { Heading, Text, Flex, List, ListItem, Divider, Link, Image, Box } from "@chakra-ui/core";
  ...
  <DefaultLayout>
    ...
    <Flex py="20px">
      ...
      <Flex flexDirection="column" width={{ base:"100%", lg:"80%" }} fontSize="17px">
        <Text> We’d love to connect with you. Here are some ways you can get in touch.</Text>
        <List styleType="disc">
        ...
        <Text fontWeight="bold">Follow Us on Social Media</Text>
      </Flex>
    </Flex>
    ...
    <Flex py="20px"> 
      ...
      <Flex width={{ base:"100%", lg:"80%" }} wrap="wrap">
        <Box width={{ base:"100%", md:"50%" }}>
          <Text fontSize="14px">06.03.2020 • The New York Times</Text>
          <Link href="https://www.nytimes.com/2020/06/03/health/coronavirus-contact-tracing-apps.html" fontSize="19px" fontWeight="bold">Contact Tracing With Your Phone: It’s Easier but There Are Tradeoffs</Link>
        </Box>
        <Box width={{ base:"100%", md:"50%" }}>
          <Text fontSize="14px">06.03.2020 • The New York Times</Text>
          <Link href="https://www.nytimes.com/2020/06/03/health/coronavirus-contact-tracing-apps.html" fontSize="19px" fontWeight="bold">Contact Tracing With Your Phone: It’s Easier but There Are Tradeoffs</Link>
